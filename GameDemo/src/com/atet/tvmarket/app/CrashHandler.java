...
public class CrashHandler implements UncaughtExceptionHandler {  
   ...
   private boolean handleException(Throwable ex) {  
       ...
       new Thread() {  
           ...
           public void run() {  
               Looper.prepare();  
               NewToast.makeToast(mContext, "很抱歉,程序出现异常,即将退出.", Toast.LENGTH_LONG).show();  
               Looper.loop();  
           }  
       }.start();  
       //收集设备参数信息   
       ...
       try {  
           ...
           if (pi != null) {  
               ...
               infos.put("versionName", versionName);  
				infos.put("exceptionName", "unknown");
...
//        	   path = Environment.getExternalStorageDirectory().getPath()+"/ATET/"+context.getPackageName()+"/crash/";
