...
// KEEP INCLUDES END
/**
 * Entity mapped to table GAME_RANKING.
 */
public class GameRanking implements java.io.Serializable {
    ...
    public GameRanking(Long id) {
        this.id = id;
    }

    public GameRanking(Long id, Integer returnOrder, int type, String gameId) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getGameRankingDao() : null;
    }
