 ...
 */
public class GameCenterInsetDecoration extends RecyclerView.ItemDecoration {

    private int mInsets_top,mInsets_right,mInsets_bottom,mInsets_left;

    public GameCenterInsetDecoration(Context context) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        outRect.set(-(int)ScaleViewUtils.resetTextSize(104), 0, 0, 0);
    }
}