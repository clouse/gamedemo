 ...
 */
public class PromotionDetailInsetDecoration extends RecyclerView.ItemDecoration {

    private int mInsets_top,mInsets_right,mInsets_bottom,mInsets_left;

    public PromotionDetailInsetDecoration(Context context) {
