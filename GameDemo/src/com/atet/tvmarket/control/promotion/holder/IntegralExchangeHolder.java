...
import com.atet.tvmarket.control.promotion.activity.GiftActivity.FocusChangeListener;
 ...
 *
 */
public class IntegralExchangeHolder extends ViewHolder implements
		OnClickListener {
	...
	public IntegralExchangeHolder(View itemView, RecyclerView recyclerView,
	...
	private void initView() {
		...
		item_shadow = (BaseImageView) itemView
				.findViewById(R.id.integral_exchange_item_shadow);
		item_content = (RelativeLayout) itemView
				.findViewById(R.id.integral_exchange_item_content);
		item_name = (CloseAcceTextView) itemView
				.findViewById(R.id.integral_exchange_item_name);
		item_iv = (BaseImageView) itemView
				.findViewById(R.id.integral_exchange_item_iv);
	...
	public void setData(GoodsInfo goodsInfo) {
		mImageFetcher.loadImage(goodsInfo.getErectPhoto(), item_iv,
				R.drawable.default_vertical);
		item_name.setText(goodsInfo.getName());
	}
		...
		public void onFocusChange(View v, boolean hasFocus) {
			if (hasFocus) {
				...
				if (location[0] + v.getWidth() > BaseApplication.mScreenWidth) {
					mRecyclerView.smoothScrollBy((int) (v.getWidth()*1.15), 0);
				}
				...
				if (v.getId() == R.id.integral_exchange_item_content) {
