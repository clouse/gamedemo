...
public class SacleInItemAnimator extends ItemAnimator {
	...
	public boolean animateAdd(ViewHolder holder) 
	{
        ...
        ViewCompat.animate(holder.itemView).scaleX(1f).scaleY(1).setDuration(400).setListener(new ViewPropertyAnimatorListener() {
