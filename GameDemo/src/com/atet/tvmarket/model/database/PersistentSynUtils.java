...
public class PersistentSynUtils {
	 ...
	 * 
	 * @param model
	 * @return 返回插入记录的autoIncrementId值
	 */
    ...
    /**
     * 用来查询数据库中，特定表的记录，查询条件为指定的列与它们的值
     * 
     * @author zhaominglai
     * @date 2014/6/24
     * 
     * 
     * */
    public static <T extends AutoType> Group<T> queryModel(
			Class<?> modelType, String[] columns,String[] values) {
    	
    	StringBuilder sql = new StringBuilder();
    	String tablename = BaseModelTool.getTableName(modelType);
    	...
    	return getModelListBySQL(modelType, s, values);
