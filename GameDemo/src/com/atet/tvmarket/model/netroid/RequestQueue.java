...
public class RequestQueue {
    ...
    /**
     * @description: post to ui thread
     *
     * @param r 
     * @throws: 
     * @author: LiuQin
     * @date: 2015年7月3日 上午10:43:09
     */
    public void postUiThread(Runnable r){
    	if(r!=null){
    		mDelivery.postUiThread(r);
    	}
    }
    
    /**
     * @description: Is task already in queue
     *
     * @param tag 
     * @param filter
     * @author: LiuQin
     */
    public boolean isInQueue(final Object tag, RequestFilter filter) {
        if (tag == null) {
            throw new IllegalArgumentException("Cannot cancelAll with a null tag");
        }
