package com.atet.tvmarket.view.blur;
...
public class BlurringView extends View {
    ...
    public BlurringView(Context context, AttributeSet attrs) {
        ...
        setBlurRadius(BlurredConfig.BLUR_RADIUS);
        setDownsampleFactor(BlurredConfig.DOWNSAMPLE_FACTOR);
        setOverlayColor(BlurredConfig.OVERLAY_COLOR);
    }
