package com.atet.statistics.net;
	...
	public byte[] getGameOnlineJson()
	{
		...
		try {
			...
			for (int i = 0;i < this.gameOnlineTimeInfoData.size();i++)
			{
				...
				obj.put("handleMac", this.gameOnlineTimeInfoData.get(i).getHandleMac());
				obj.put("handleProductId", this.gameOnlineTimeInfoData.get(i).getHandleProductId());
				obj.put("handleFactoryId", this.gameOnlineTimeInfoData.get(i).getHandleFactoryId());
				obj.put("handleName", this.gameOnlineTimeInfoData.get(i).getHandleName());
				obj.put("isUseHandle", this.gameOnlineTimeInfoData.get(i).getIsUseHandle());
