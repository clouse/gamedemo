...
public class PlatFormOnlineService extends IntentService {
	...
	{
		List<InitInfo> recordList = PersistentSynUtils.getModelList(InitInfo.class," autoIncrementId > 0");
	...
	{
		List<InitInfo> recordList = PersistentSynUtils.getModelList(InitInfo.class, " autoIncrementId = "+ id);
